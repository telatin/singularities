...
%post
    ...
    /opt/software/conda/bin/conda create -p /opt/software/conda_env -y fastp samtools=1.10 bedtools covtobed n50 seqfu subread seqtk seqkit bedops vsearch bwa bamtools sambamba blast
    source /opt/software/conda/bin/activate /opt/software/conda_env
